...
Run `ng serve` for a dev server. Navigate to `http://localhost:4200/`. The application will automatically reload if you change any of the source files. If you need to access the Search Recent Tweets feature, you will also need to download the NodeJS/Express application mentioned [above](https://github.com/mcoleman1/practical-assessment-backend) and run `npm run dev` from the project root. 
